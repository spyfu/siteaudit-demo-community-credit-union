...
$expectedRepository = 'spyfu/siteaudit-demo-community-credit-union'
$expectedRemoteHttps = 'https://github.com/spyfu/siteaudit-demo-community-credit-union.git'
$expectedRemoteSsh = 'git@github.com:spyfu/siteaudit-demo-community-credit-union.git'
